...
def test_1830_manual_actions():
    ...
    expected_state = {
        "players": {
            ...
            "Player 4": {"cash": 104, "shares": {"PRR": 40, "B&O": 20, "C&O": 10, "NYC": 10}, "companies": ["CA", "BO"]}
        },
        "corporations": {
    ...
    expected_state = {
        "players": {
            ...
            "Player 4": {"cash": 249, "shares": {"PRR": 40, "B&O": 20, "C&O": 10, "NYC": 10}, "companies": ["CA", "BO"]}
        },
        "corporations": {
    ...
    expected_state = {
        "players": {
            ...
            "Player 4": {"cash": 104, "shares": {"PRR": 40, "B&O": 40, "C&O": 10, "NYC": 10}, "companies": ["CA", "BO"]}
        },
        "corporations": {
    ...
    expected_state = {
        "players": {
            "Player 1": {"cash": 11, "shares": {"PRR": 60, "NYC": 50, "C&O": 30, "B&O": 10, "ERIE": 10}, "companies": []},
            ...
            "Player 4": {"cash": 10, "shares": {"PRR": 40, "B&O": 50, "C&O": 10, "NYC": 20, "ERIE": 40}, "companies": []}
        },
        "corporations": {
    ...
    g.process_action(
        action_helper.get_all_choices()[0]
    )  # [18:12] PRR pays out 13 per share (52 to Player 4)
    ...
    g.process_action(
        action_helper.get_all_choices()[0]
    )  # [18:21] NYNH pays out 25 per share (125 to Player 3)
    ...
    g.process_action(
        action_helper.get_all_choices()[0]
    )  # [18:22] NYNH pays out 29 per share (145 to Player 3)
    ...
    expected_state = {
        "players": {
            "Player 1": {"cash": 221, "shares": {"PRR": 60, "NYC": 50, "C&O": 30, "B&O": 10, "ERIE": 10}, "companies": []},
            ...
            "Player 4": {"cash": 253, "shares": {"PRR": 40, "B&O": 50, "C&O": 10, "NYC": 20, "ERIE": 40}, "companies": []}
        },
        "corporations": {
    ...
    expected_state = {
        "players": {
            "Player 1": {"cash": 99, "shares": {"PRR": 30, "NYC": 50, "C&O": 30, "B&O": 10, "ERIE": 0, "B&M": 60}, "companies": []},
            "Player 2": {"cash": 151, "shares": {"C&O": 60, "NYC": 0, "NYNH": 20, "ERIE": 50, "CPR": 60}, "companies": []},
            "Player 3": {"cash": 21, "shares": {"NYC": 30, "NYNH": 60, "B&O": 40, "ERIE": 10, "CPR": 20, "PRR": 10}, "companies": []},
            "Player 4": {"cash": 53, "shares": {"PRR": 40, "B&O": 50, "C&O": 10, "NYC": 20, "ERIE": 40, "CPR": 20}, "companies": []}
        },
        "corporations": {
    ...
    g.process_action(
        action_helper.get_all_choices()[0]
    )  # [20:28] B&M pays out 17 per share ($102 to Player 1)
    ...
    g.process_action(
        action_helper.get_all_choices()[0]
    )  # [21:36] B&M pays out 17 per share ($102 to Player 1)
    ...
    g.process_action(
        action_helper.get_all_choices()[0]
    )  # [21:36] CPR pays out 5 per share (15 to CPR, $5 to Player 4)
    ...
    g.process_action(
        action_helper.get_all_choices()[0]
    )  # [21:38] ERIE pays out 17 per share (85 to ERIE)
    ...
    expected_state = {
        "players": {
            "Player 1": {"cash": 906, "shares": {"PRR": 30, "NYC": 50, "C&O": 30, "B&O": 10, "ERIE": 0, "B&M": 60}, "companies": []},
            "Player 2": {"cash": 885, "shares": {"C&O": 60, "NYC": 0, "NYNH": 20, "ERIE": 50, "CPR": 60}, "companies": []},
            "Player 3": {"cash": 163, "shares": {"NYC": 0, "NYNH": 60, "B&O": 0, "ERIE": 0, "CPR": 0, "PRR": 0}, "companies": []},
            "Player 4": {"cash": 327, "shares": {"PRR": 40, "B&O": 50, "C&O": 10, "NYC": 20, "ERIE": 0, "CPR": 10}, "companies": []}
        },
        "corporations": {
    ...
    expected_state = {
        "players": {
            "Player 1": {"cash": 570, "shares": {"PRR": 30, "NYC": 60, "C&O": 30, "B&O": 30, "ERIE": 20, "B&M": 60}, "companies": []},
            "Player 2": {"cash": 885, "shares": {"C&O": 60, "NYC": 0, "NYNH": 20, "ERIE": 50, "CPR": 60}, "companies": []},
            "Player 3": {"cash": 36, "shares": {"NYC": 10, "NYNH": 60, "B&O": 10, "ERIE": 0, "CPR": 0, "PRR": 0}, "companies": []},
            "Player 4": {"cash": 48, "shares": {"PRR": 60, "B&O": 60, "C&O": 10, "NYC": 30, "ERIE": 0, "CPR": 10}, "companies": []}
        },
        "corporations": {
            "PRR": {"cash": 54, "companies": [], "trains": ["D"], "share_price": 76},
