...
def test_1830_manual_actions():
    ...
    g.process_action(action_helper.get_all_choices(g)[1])  # bid 50 on CS
    g.process_action(action_helper.get_all_choices(g)[-77])  # bid 225 on BO
    g.process_action(action_helper.get_all_choices(g)[0])  # buy SV
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass
    g.process_action(action_helper.get_all_choices(g)[0])  # buy DH
    g.process_action(action_helper.get_all_choices(g)[0])  # buy MH
    g.process_action(action_helper.get_all_choices(g)[0])  # buy CA
    g.process_action(action_helper.get_all_choices(g)[0])  # Par B&O at 100
    ...
    assert action_helper.get_state(g) == expected_state, "State does not match expected state after initial auction"

    # Stock Round 1
    g.process_action(action_helper.get_all_choices(g)[-2])  # Par PRR
    g.process_action(action_helper.get_all_choices(g)[-1])  # Pass
    ...
    g.process_action(action_helper.get_all_choices(g)[1])  # Buy PRR
    g.process_action(action_helper.get_all_choices(g)[1])  # Buy PRR
    g.process_action(action_helper.get_all_choices(g)[3])  # Buy C&O
    g.process_action(action_helper.get_all_choices(g)[2])  # Buy NYC
    g.process_action(action_helper.get_all_choices(g)[0])  # Buy PRR
    g.process_action(action_helper.get_all_choices(g)[1])  # Buy PRR
    g.process_action(action_helper.get_all_choices(g)[3])  # Buy C&O
    g.process_action(action_helper.get_all_choices(g)[2])  # Buy NYC
    g.process_action(action_helper.get_all_choices(g)[1])  # Buy PRR
    g.process_action(action_helper.get_all_choices(g)[2])  # Buy C&O
    g.process_action(action_helper.get_all_choices(g)[1])  # Buy NYC
    g.process_action(action_helper.get_all_choices(g)[1])  # Buy NYC
    g.process_action(action_helper.get_all_choices(g)[2])  # Buy C&O
    g.process_action(action_helper.get_all_choices(g)[1])  # Buy NYC
    g.process_action(action_helper.get_all_choices(g)[1])  # Buy NYC
    ...
    # Operating Round 1
    # PRR
    g.process_action(action_helper.get_all_choices(g)[0])  # lays tile #57 with rotation 1 on H10
    g.process_action(action_helper.get_all_choices(g)[-1])  # passes place token
    g.process_action(action_helper.get_all_choices(g)[0])  # buys a 2 train
    g.process_action(action_helper.get_all_choices(g)[0])  # buys a 2 train
    g.process_action(action_helper.get_all_choices(g)[-1])  # passes trains

    # NYC
    g.process_action(action_helper.get_all_choices(g)[0])  # lays tile #57 with rotation 0 on E19
    g.process_action(action_helper.get_all_choices(g)[0])  # buys a 2 train
    g.process_action(action_helper.get_all_choices(g)[-1])  # passes trains
    ...
    # Stock Round 2
    g.process_action(action_helper.get_all_choices(g)[-2])  # sell nyc
    g.process_action(action_helper.get_all_choices(g)[-3])  # par nynh
    g.process_action(action_helper.get_all_choices(g)[0])  # buy C&O
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass sell
    g.process_action(action_helper.get_all_choices(g)[0])  # Buy NYC
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass sell
    g.process_action(action_helper.get_all_choices(g)[0])  # Buy NYNH
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass sell
    g.process_action(action_helper.get_all_choices(g)[1])  # Buy NYNH
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass sell
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass
    ...
    assert action_helper.get_state(g) == expected_state, "State does not match expected state after stock round 2"
    ...
    assert action_helper.get_state(g) == expected_state, "State does not match expected state after operating round 2"

    # Stock Round 3
    g.process_action(action_helper.get_all_choices(g)[2])  # Buy NYC
    g.process_action(action_helper.get_all_choices(g)[-1])  # Pass Sell

    g.process_action(action_helper.get_all_choices(g)[3])  # Buy NYC
    g.process_action(action_helper.get_all_choices(g)[-1])  # Pass Sell

    g.process_action(action_helper.get_all_choices(g)[3])  # Buy NYC
    g.process_action(action_helper.get_all_choices(g)[-1])  # Pass Sell

    g.process_action(action_helper.get_all_choices(g)[3])  # Exchange for NYC
    g.process_action(action_helper.get_all_choices(g)[1])  # Buy last NYC
    g.process_action(action_helper.get_all_choices(g)[-1])  # Pass sell
    ...
    assert action_helper.get_state(g) == expected_state, "State does not match expected state after stock round 3"

    # Operating Round 3
    # PRR
    g.process_action(action_helper.get_all_choices(g)[14])  # lay tile 8 with rotation 2 on H6
    g.process_action(action_helper.get_all_choices(g)[0])  # Token Pittsburgh
    g.process_action(action_helper.get_all_choices(g)[0])  # Run 2 train for 30
    g.process_action(action_helper.get_all_choices(g)[0])  # pay out
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass trains
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass companies

    # NYNH
    g.process_action(action_helper.get_all_choices(g)[-5])  # Buy C&S
    g.process_action(action_helper.get_all_choices(g)[2])  # lay tile 54 with rotation 0 on G19
    g.process_action(action_helper.get_all_choices(g)[-1])  # run routes
    g.process_action(action_helper.get_all_choices(g)[0])  # pay out
    ...
    # C&O
    g.process_action(action_helper.get_all_choices(g)[33])  # Lay tile 57 with rotation 1 on F16
    g.process_action(action_helper.get_all_choices(g)[0])  # Token teleport
    g.process_action(action_helper.get_all_choices(g)[0])  # run routes
    g.process_action(action_helper.get_all_choices(g)[0])  # pay out
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass companies

    # NYC
    g.process_action(action_helper.get_all_choices(g)[14])  # lay tile 19 with rotation 1 on F18
    g.process_action(action_helper.get_all_choices(g)[0])  # run trains
    g.process_action(action_helper.get_all_choices(g)[0])  # pay out
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass trains
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass companies

    # PRR
    g.process_action(action_helper.get_all_choices(g)[0])  # lay tile 25 with rotation 1 on g5
    g.process_action(action_helper.get_all_choices(g)[0])  # run routes
    g.process_action(action_helper.get_all_choices(g)[0])  # pay out
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass trains
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass companies
    ...
    # NYNH
    g.process_action(action_helper.get_all_choices(g)[0])  # lay tile 14 with rotation 0 on E19
    g.process_action(action_helper.get_all_choices(g)[0])  # place a token on E19
    g.process_action(action_helper.get_all_choices(g)[0])  # run trains
    g.process_action(action_helper.get_all_choices(g)[0])  # pay out
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass trains
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass companies
    ...
    # C&O
    g.process_action(action_helper.get_all_choices(g)[17])  # lay tile 15 with rotation 4 on F16
    g.process_action(action_helper.get_all_choices(g)[0])  # run trains
    g.process_action(action_helper.get_all_choices(g)[0])  # pay out
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass companies

    # NYC
    g.process_action(action_helper.get_all_choices(g)[12])  # lay tile #7 with rotation 0 on E21
    g.process_action(action_helper.get_all_choices(g)[0])  # place token on F16
    g.process_action(action_helper.get_all_choices(g)[0])  # run trains
    g.process_action(action_helper.get_all_choices(g)[0])  # pay out
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass trains
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass companies
    ...
    assert action_helper.get_state(g) == expected_state, "State does not match expected state after operating round 3"

    # Stock Round 4
    g.process_action(action_helper.get_all_choices(g)[0])  # buy B&O
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass sell
    ...
    g.process_action(action_helper.get_all_choices(g)[1])  # buy C&O
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass sell
    ...
    assert action_helper.get_state(g) == expected_state, "State does not match expected state after stock round 4"

    # Operating Round 4
    # PRR
    g.process_action(action_helper.get_all_choices(g)[13])  # lay tile #8 with rotation 5 on H14
    g.process_action(action_helper.get_all_choices(g)[0])  # Run trains
    g.process_action(action_helper.get_all_choices(g)[0])  # pay out
    g.process_action(action_helper.get_all_choices(g)[0])  # buy 3 train
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass trains
    ...
    # B&O
    g.process_action(action_helper.get_all_choices(g)[-8])  # buy C&A for max
    g.process_action(action_helper.get_all_choices(g)[1])  # lay tile #8 with rotation 1 on I17
    g.process_action(action_helper.get_all_choices(g)[0])  # buy 3 train
    g.process_action(action_helper.get_all_choices(g)[0])  # buy 4 train

    # NYNH
    g.process_action(action_helper.get_all_choices(g)[17])  # lay tile #57 with rotation 1 on F22
    g.process_action(action_helper.get_all_choices(g)[0])  # run trains
    g.process_action(action_helper.get_all_choices(g)[0])  # pay out

    # C&O
    g.process_action(action_helper.get_all_choices(g)[26])  # lay tile #56 with rotation 1 on G17
    g.process_action(action_helper.get_all_choices(g)[0])  # place token on G19
    g.process_action(action_helper.get_all_choices(g)[0])  # run trains
    g.process_action(action_helper.get_all_choices(g)[0])  # pay out

    # NYC
    g.process_action(action_helper.get_all_choices(g)[13])  # lay tile #26 with rotation 1 on E21
    g.process_action(action_helper.get_all_choices(g)[0])  # run trains
    g.process_action(action_helper.get_all_choices(g)[0])  # pay out
    g.process_action(action_helper.get_all_choices(g)[109])  # buy a 3 train for $110 from PRR

    # PRR
    g.process_action(action_helper.get_all_choices(g)[34])  # lay tile #53 with rotation 0 on I15
    g.process_action(action_helper.get_all_choices(g)[0])  # buy 4 train
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass trains

    # NYNH
    g.process_action(action_helper.get_all_choices(g)[18])  # tile #53 with rotation 1 on E23
    g.process_action(action_helper.get_all_choices(g)[0])  # runs a 3 train for $140: G19-E19-E23
    g.process_action(action_helper.get_all_choices(g)[1])  # withholds $140
    g.process_action(action_helper.get_all_choices(g)[0])  # buys a 4 train for $300 from The Depot

    # B&O
    g.process_action(action_helper.get_all_choices(g)[12])  # lay tile #59 with rotation 0 on H18
    g.process_action(action_helper.get_all_choices(g)[-1])  # skip token
    g.process_action(action_helper.get_all_choices(g)[0])  # run trains
    g.process_action(action_helper.get_all_choices(g)[0])  # pay out

    # C&O
    g.process_action(action_helper.get_all_choices(g)[18])  # lay tile #69 with rotation 0 on G7
    g.process_action(action_helper.get_all_choices(g)[0])  # run trains
    g.process_action(action_helper.get_all_choices(g)[0])  # pay out

    # NYC
    g.process_action(action_helper.get_all_choices(g)[22])  # lay tile 9 with rotation 1 on F14
    g.process_action(action_helper.get_all_choices(g)[-1])  # skip token
    g.process_action(action_helper.get_all_choices(g)[0])  # run trains
    g.process_action(action_helper.get_all_choices(g)[0])  # pay out
    g.process_action(action_helper.get_all_choices(g)[-1])  # pass trains
    ...
    assert action_helper.get_state(g) == expected_state, "State does not match expected state after operating round 4"

    # Stock Round 5
    g.process_action(
        action_helper.get_all_choices(g)[0]
    )  # [18:00] Player 3 buys a 10% share of B&O from the IPO for $100
    g.process_action(action_helper.get_all_choices(g)[-1])  # [18:00] Player 3 declines to sell shares
    g.process_action(
        action_helper.get_all_choices(g)[0]
    )  # [18:00] Player 4 buys a 10% share of B&O from the IPO for $100
    g.process_action(action_helper.get_all_choices(g)[-1])  # [18:00] Player 4 declines to sell shares
    g.process_action(
        action_helper.get_all_choices(g)[0]
    )  # [18:00] Player 1 buys a 10% share of B&O from the IPO for $100
    g.process_action(action_helper.get_all_choices(g)[-1])  # [18:00] Player 1 declines to sell shares
    g.process_action(action_helper.get_all_choices(g)[12])  # [18:01] Player 2 pars ERIE at $100
    # [18:01] Player 2 buys a 20% share of ERIE from the IPO for $200
    # [18:01] Player 2 becomes the president of ERIE
    g.process_action(action_helper.get_all_choices(g)[-1])  # [18:01] Player 2 declines to sell shares
    g.process_action(
        action_helper.get_all_choices(g)[0]
    )  # [18:01] Player 3 buys a 10% share of ERIE from the IPO for $100
    g.process_action(action_helper.get_all_choices(g)[-1])  # [18:04] Player 3 declines to sell shares
    g.process_action(
        action_helper.get_all_choices(g)[0]
    )  # [18:04] Player 4 buys a 10% share of ERIE from the IPO for $100
    g.process_action(action_helper.get_all_choices(g)[-1])  # [18:04] Player 4 declines to sell shares
    g.process_action(
        action_helper.get_all_choices(g)[0]
    )  # [18:04] Player 1 buys a 10% share of ERIE from the IPO for $100
    g.process_action(action_helper.get_all_choices(g)[-1])  # [18:04] Player 1 declines to sell shares
    g.process_action(action_helper.get_all_choices(g)[0])  # [18:05] Player 2 sells a 10% share of NYC and receives $68
    g.process_action(
        action_helper.get_all_choices(g)[0]
    ...
    g.process_action(action_helper.get_all_choices(g)[0])  # [18:05] Player 2 sells a 10% share of NYC and receives $68
    g.process_action(action_helper.get_all_choices(g)[-1])  # [18:05] Player 2 passes
    g.process_action(action_helper.get_all_choices(g)[-1])  # [18:05] Player 3 passes
    g.process_action(
        action_helper.get_all_choices(g)[0]
    )  # [18:05] Player 4 buys a 10% share of ERIE from the IPO for $100
    g.process_action(action_helper.get_all_choices(g)[-1])  # [18:05] Player 4 declines to sell shares
    g.process_action(
        action_helper.get_all_choices(g)[0]
    )  # [18:05] Player 1 buys a 10% share of NYC from the market for $68
    g.process_action(action_helper.get_all_choices(g)[-1])  # [18:05] Player 1 declines to sell shares
    g.process_action(
        action_helper.get_all_choices(g)[0]
    )  # [18:06] Player 2 buys a 10% share of ERIE from the IPO for $100
    g.process_action(action_helper.get_all_choices(g)[-1])  # [18:06] Player 2 declines to sell shares
    g.process_action(action_helper.get_all_choices(g)[-1])  # [18:06] Player 3 passes
    g.process_action(
        action_helper.get_all_choices(g)[0]
    )  # [18:06] Player 4 buys a 10% share of ERIE from the IPO for $100
    g.process_action(action_helper.get_all_choices(g)[-1])  # [18:06] Player 4 declines to sell shares
    g.process_action(action_helper.get_all_choices(g)[-1])  # [18:06] Player 1 passes
    g.process_action(action_helper.get_all_choices(g)[-1])  # [18:06] Player 2 passes
    g.process_action(action_helper.get_all_choices(g)[-1])  # [18:06] Player 3 passes
    g.process_action(
        action_helper.get_all_choices(g)[0]
    )  # [18:06] Player 4 buys a 10% share of ERIE from the IPO for $100
    ...
    assert action_helper.get_state(g) == expected_state, "State does not match expected state after stock round 5"
    ...
    g.process_action(
        action_helper.get_all_choices(g)[8]
    )  # [18:12] PRR lays tile #15 with rotation 1 on H10 (Pittsburgh)
    # [18:12] PRR skips place a token
    g.process_action(action_helper.get_all_choices(g)[0])  # [18:12] PRR runs a 4 train for $130: F2-H10-H12-I15
    g.process_action(action_helper.get_all_choices(g)[0])  # [18:12] PRR pays out 13 per share (52 to Player 4)
    # [18:12] PRR's share price moves right from 142
    g.process_action(action_helper.get_all_choices(g)[-1])  # [18:12] PRR passes buy trains
    # [18:12] PRR skips buy companies

    # [18:12] Player 4 operates B&O
    g.process_action(
        action_helper.get_all_choices(g)[43]
    )  # [18:13] B&O spends $80 and lays tile #57 with rotation 0 on J14 (Washington)
    g.process_action(action_helper.get_all_choices(g)[1])  # [18:13] B&O places a token on H10 (Pittsburgh) for $40
    g.process_action(action_helper.get_all_choices(g)[0])  # [18:13] B&O runs a 4 train for $140: K13-J14-I15-H18
    ...
    g.process_action(action_helper.get_all_choices(g)[1])  # [18:13] ERIE places a token on E11 (Dunkirk & Buffalo)
    ...
    g.process_action(action_helper.get_all_choices(g)[0])  # [18:13] ERIE buys a 4 train for $300 from The Depot
    g.process_action(action_helper.get_all_choices(g)[0])  # [18:13] ERIE buys a 5 train for $450 from The Depot
    ...
    g.process_action(
        action_helper.get_all_choices(g)[52]
    ...
    g.process_action(action_helper.get_all_choices(g)[6])  # [18:19] NYNH lays tile #63 with rotation 0 on E19 (Albany)
    # [18:19] NYNH skips place a token
    g.process_action(action_helper.get_all_choices(g)[0])  # [18:19] NYNH runs a 4 train for $100: G19-F20-F22-F24
    # [18:19] NYNH runs a 3 train for $150: G19-E19-E23
    g.process_action(action_helper.get_all_choices(g)[0])  # [18:21] NYNH pays out 25 per share (125 to Player 3)
    ...
    g.process_action(
        action_helper.get_all_choices(g)[62]
    ...
    g.process_action(action_helper.get_all_choices(g)[0])  # [18:21] NYC runs a 3 train for $170: G19-E19-E23
    # [18:21] NYC runs a 3 train for $180: G19-H18-I15
    g.process_action(action_helper.get_all_choices(g)[1])  # [18:21] NYC withholds $350
    ...
    g.process_action(action_helper.get_all_choices(g)[3])  # [18:21] PRR lays tile #9 with rotation 0 on G11
    # [18:21] PRR skips place a token
    g.process_action(action_helper.get_all_choices(g)[0])  # [18:21] PRR runs a 4 train for $160: F2-H10-H12-I15
    g.process_action(action_helper.get_all_choices(g)[1])  # [18:21] PRR withholds $160
    # [18:21] PRR's share price moves left from 126
    g.process_action(action_helper.get_all_choices(g)[-1])  # [18:21] PRR passes buy trains
    # [18:21] PRR skips buy companies

    # [18:21] Player 4 operates B&O
    g.process_action(
        action_helper.get_all_choices(g)[59]
    )  # [18:22] B&O lays tile #61 with rotation 0 on I15 (Baltimore)
    # [18:22] B&O skips place a token
    g.process_action(action_helper.get_all_choices(g)[0])  # [18:22] B&O runs a 4 train for $170: K13-J14-I15-H18
    # [18:22] B&O runs a 3 train for $160: I15-H10-F2
    g.process_action(action_helper.get_all_choices(g)[1])  # [18:22] B&O withholds $330
    ...
    g.process_action(action_helper.get_all_choices(g)[3])  # [18:22] NYNH lays tile #8 with rotation 5 on D18
    # [18:22] NYNH skips place a token
    g.process_action(action_helper.get_all_choices(g)[0])  # [18:22] NYNH runs a 4 train for $120: G19-F20-F22-F24
    # [18:22] NYNH runs a 3 train for $170: G19-E19-E23
    g.process_action(action_helper.get_all_choices(g)[0])  # [18:22] NYNH pays out 29 per share (145 to Player 3)
    ...
    g.process_action(action_helper.get_all_choices(g)[5])  # [18:22] ERIE lays tile #8 with rotation 2 on F12
    # [18:22] ERIE skips place a token
    g.process_action(action_helper.get_all_choices(g)[0])  # [18:22] ERIE runs a 4 train for $70: E11-F16
    g.process_action(
        action_helper.get_all_choices(g)[0]
    ...
    g.process_action(action_helper.get_all_choices(g)[0])  # [18:23] C&O runs a 5 train for $220: E11-F16-G17-G19-H18
    ...
    g.process_action(action_helper.get_all_choices(g)[3])  # [18:23] NYC lays tile #9 with rotation 1 on D16
    ...
    assert action_helper.get_state(g) == expected_state, "State does not match expected state after operating round 5"

    # Stock Round 6
    g.process_action(action_helper.get_all_choices(g)[0])  # [19:11] Player 1 pars B&M at $100
    # [19:11] Player 1 buys a 20% share of B&M from the IPO for $200
    # [19:11] Player 1 becomes the president of B&M
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:11] Player 1 declines to sell shares
    g.process_action(action_helper.get_all_choices(g)[1])  # [19:12] Player 2 pars CPR at $100
    # [19:12] Player 2 buys a 20% share of CPR from the IPO for $200
    # [19:12] Player 2 becomes the president of CPR
    g.process_action(action_helper.get_all_choices(g)[9])  # [19:13] Player 2 sells a 10% share of NYNH and receives $111
    # [19:13] NYNH's share price moves down from 100
    g.process_action(action_helper.get_all_choices(g)[-1])
    g.process_action(
        action_helper.get_all_choices(g)[2]
    )  # [19:14] Player 3 buys a 10% share of CPR from the IPO for $100
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:14] Player 3 declines to sell shares
    g.process_action(
        action_helper.get_all_choices(g)[2]
    )  # [19:14] Player 4 buys a 10% share of CPR from the IPO for $100
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:14] Player 4 declines to sell shares
    g.process_action(action_helper.get_all_choices(g)[2])  # [19:15] Player 1 sells 3 shares of PRR and receives $378
    ...
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:15] Player 2 declines to sell shares
    g.process_action(
        action_helper.get_all_choices(g)[0]
    )  # [19:15] Player 3 buys a 10% share of NYNH from the market for $100
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:15] Player 3 declines to sell shares
    g.process_action(
        action_helper.get_all_choices(g)[1]
    )  # [19:15] Player 4 buys a 10% share of CPR from the IPO for $100
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:15] Player 4 declines to sell shares
    g.process_action(
        action_helper.get_all_choices(g)[0]
    )  # [19:15] Player 1 buys a 10% share of B&M from the IPO for $100
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:16] Player 1 declines to sell shares
    g.process_action(
        action_helper.get_all_choices(g)[1]
    )  # [19:16] Player 2 buys a 10% share of CPR from the IPO for $100
    # [19:16] CPR floats
    # [19:16] CPR receives $1000
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:16] Player 2 declines to sell shares
    g.process_action(
        action_helper.get_all_choices(g)[2]
    )  # [19:16] Player 3 buys a 10% share of PRR from the market for $90
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:16] Player 3 declines to sell shares
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:16] Player 4 passes
    g.process_action(
        action_helper.get_all_choices(g)[0]
    ...
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:17] Player 2 declines to sell shares
    g.process_action(
        action_helper.get_all_choices(g)[1]
    )  # [19:18] Player 3 buys a 10% share of CPR from the IPO for $100
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:18] Player 3 declines to sell shares
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:18] Player 4 passes
    g.process_action(
        action_helper.get_all_choices(g)[0]
    )  # [19:18] Player 1 buys a 10% share of B&M from the IPO for $100
    # [19:18] B&M floats
    # [19:18] B&M receives $1000
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:18] Player 1 declines to sell shares
    g.process_action(action_helper.get_all_choices(g)[-4])  # [19:18] Player 2 sells 2 shares of NYNH and receives $200
    # [19:18] NYNH's share price moves down from 80
    g.process_action(
        action_helper.get_all_choices(g)[1]
    )  # [19:18] Player 2 buys a 10% share of CPR from the IPO for $100
    g.process_action(action_helper.get_all_choices(g)[-1])
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:19] Player 3 passes
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:19] Player 4 passes
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:19] Player 1 passes
    g.process_action(
        action_helper.get_all_choices(g)[1]
    )  # [19:19] Player 2 buys a 10% share of CPR from the IPO for $100
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:19] Player 2 declines to sell shares
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:19] Player 3 passes
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:19] Player 4 passes
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:19] Player 1 passes
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:19] Player 2 passes
    action_helper.print_summary(g, json_format=True)
    expected_state = {
        "players": {
            "Player 1": {
    ...
    assert action_helper.get_state(g) == expected_state, "State does not match expected state after stock round 6"

    # Operating Round 6
    # [19:19] Player 2 operates C&O
    g.process_action(action_helper.get_all_choices(g)[43])  # [19:21] C&O lays tile #9 with rotation 1 on G9
    # [19:21] C&O skips place a token
    g.process_action(action_helper.get_all_choices(g)[0])  # [19:21] C&O runs a 5 train for $220: E11-F16-G17-G19-H18
    ...
    g.process_action(action_helper.get_all_choices(g)[16])  # [19:22] B&O lays tile #46 with rotation 5 on G5
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:22] B&O passes place a token
    g.process_action(action_helper.get_all_choices(g)[0])  # [19:22] B&O runs a 4 train for $170: K13-J14-I15-H18
    # [19:22] B&O runs a 3 train for $160: I15-H10-F2
    g.process_action(action_helper.get_all_choices(g)[1])  # [19:22] B&O withholds $330
    ...
    g.process_action(action_helper.get_all_choices(g)[9])  # [19:24] B&M lays tile #45 with rotation 4 on E21
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:24] B&M passes place a token
    # [19:24] B&M skips run routes
    # [19:24] B&M does not run
    # [19:24] B&M's share price moves left from 90
    g.process_action(action_helper.get_all_choices(g)[0])  # [19:24] B&M buys a 5 train for $450 from The Depot
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:24] B&M passes buy trains
    ...
    g.process_action(action_helper.get_all_choices(g)[0])  # [19:24] CPR buys a 6 train for $630 from The Depot
    ...
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:25] CPR passes buy trains
    # [19:25] CPR skips buy companies

    # [19:25] Player 2 operates ERIE
    g.process_action(action_helper.get_all_choices(g)[4])  # [19:25] ERIE lays tile #25 with rotation 2 on F12
    # [19:25] ERIE skips place a token
    g.process_action(action_helper.get_all_choices(g)[0])  # [19:25] ERIE runs a 5 train for $80: E11-H10
    g.process_action(action_helper.get_all_choices(g)[1])  # [19:25] ERIE withholds $80
    ...
    g.process_action(action_helper.get_all_choices(g)[33])  # [19:26] PRR lays tile #23 with rotation 1 on H14
    # [19:26] PRR skips place a token
    g.process_action(action_helper.get_all_choices(g)[0])  # [19:26] PRR runs a 4 train for $170: F2-H10-H12-I15
    g.process_action(action_helper.get_all_choices(g)[1])  # [19:27] PRR withholds $170
    # [19:27] PRR's share price moves left from 82
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:27] PRR passes buy trains
    ...
    g.process_action(action_helper.get_all_choices(g)[0])  # [19:27] NYC buys a 6 train for $630 from The Depot
    g.process_action(action_helper.get_all_choices(g)[-1])  # [19:28] NYC passes buy trains

    # [19:28] NYC skips buy companies
    # [19:28] Player 2 operates C&O
    g.process_action(action_helper.get_all_choices(g)[32])  # [20:27] C&O lays tile #23 with rotation 3 on G11
    # [20:27] C&O skips place a token
    g.process_action(action_helper.get_all_choices(g)[0])  # [20:27] C&O runs a 5 train for $220: E11-F16-G17-G19-H18
    g.process_action(
        action_helper.get_all_choices(g)[0]
    )  # [20:27] C&O pays out 22 per share (66 to Player 1, $22 to Player 4, $132 to Player 2)
    # [20:27] C&O's share price moves right to 125
    g.process_action(action_helper.get_all_choices(g)[-1])  # [20:27] C&O passes buy trains
    # [20:27] C&O skips buy companies

    # [20:27] Player 4 operates B&O
    g.process_action(action_helper.get_all_choices(g)[23])  # [20:27] B&O lays tile #43 with rotation 0 on G11
    g.process_action(action_helper.get_all_choices(g)[-1])  # [20:28] B&O passes place a token
    g.process_action(action_helper.get_all_choices(g)[0])  # [20:28] B&O runs a 4 train for $210: F2-H10-I15-H18
    g.process_action(action_helper.get_all_choices(g)[1])  # [20:28] B&O withholds $210
    ...
    g.process_action(action_helper.get_all_choices(g)[3])  # [20:28] B&M lays tile #8 with rotation 5 on D20
    g.process_action(action_helper.get_all_choices(g)[-1])  # [20:28] B&M passes place a token
    g.process_action(action_helper.get_all_choices(g)[0])  # [20:28] B&M runs a 5 train for $170: E23-F24-F22-F20-G19
    g.process_action(action_helper.get_all_choices(g)[0])  # [20:28] B&M pays out 17 per share ($102 to Player 1)
    # [20:28] B&M's share price moves right from 100
    g.process_action(action_helper.get_all_choices(g)[-1])  # [20:28] B&M passes buy trains
    ...
    g.process_action(action_helper.get_all_choices(g)[-1])  # [20:29] CPR passes buy trains
    ...
    g.process_action(action_helper.get_all_choices(g)[0])  # [20:29] ERIE runs a 5 train for $130: D10-E11-G7-F6
    g.process_action(
        action_helper.get_all_choices(g)[0]
    ...
    g.process_action(action_helper.get_all_choices(g)[9])  # [20:31] Player 3 sells 4 shares of B&O and receives $328
    # [20:31] B&O's share price moves down from 62
    g.process_action(action_helper.get_all_choices(g)[5])  # [20:31] Player 3 sells 2 shares of CPR and receives $180
    # [20:31] CPR's share price moves down from 76
    g.process_action(action_helper.get_all_choices(g)[4])  # [20:31] Player 3 sells a 10% share of ERIE and receives $71
    # [20:31] ERIE's share price moves down from 67
    g.process_action(action_helper.get_all_choices(g)[3])  # [20:31] Player 3 sells 3 shares of NYC and receives $174
    # [20:31] NYC's share price moves down from 40
    g.process_action(action_helper.get_all_choices(g)[0])  # [20:31] Player 3 sells a 10% share of PRR and receives $76
    # [20:31] PRR's share price moves down from 71
    g.process_action(action_helper.get_all_choices(g)[0])  # [20:31] Player 3 contributes $860
    ...
    g.process_action(action_helper.get_all_choices(g)[0])  # [20:32] NYC runs a 6 train for $280: I15-H18-G19-G17-F16-E11
    g.process_action(
        action_helper.get_all_choices(g)[0]
    )  # [20:32] NYC pays out 28 per share (84 to NYC, $56 to Player 4)
    # [20:32] NYC's share price moves right from 50
    g.process_action(action_helper.get_all_choices(g)[-1])  # [20:32] NYC passes buy trains
    # [20:32] NYC skips buy companies

    # [20:32] Player 2 operates C&O
    g.process_action(action_helper.get_all_choices(g)[52])  # [21:35] C&O lays tile #24 with rotation 1 on H8
    # [21:35] C&O skips place a token
    # router.debug = True
    # router.verbose = True
    g.process_action(action_helper.get_all_choices(g)[0])  # [21:36] C&O runs a 5 train for $240: F2-F16-G17-G19-H18
    g.process_action(
        action_helper.get_all_choices(g)[0]
    )  # [21:36] C&O pays out 24 per share (72 to Player 1, $24 to Player 4)
    # [21:36] C&O's share price moves right from 140
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:36] C&O passes buy trains
    # [21:36] C&O skips buy companies

    # [21:36] Player 1 operates B&M
    g.process_action(action_helper.get_all_choices(g)[1])  # [21:36] B&M lays tile #23 with rotation 1 on D18
    g.process_action(action_helper.get_all_choices(g)[0])  # [21:36] B&M places a token on D14 (Rochester) for $40
    g.process_action(action_helper.get_all_choices(g)[0])  # [21:36] B&M runs a 5 train for $170: E23-F24-F22-F20-G19
    g.process_action(action_helper.get_all_choices(g)[0])  # [21:36] B&M pays out 17 per share ($102 to Player 1)
    # [21:36] B&M's share price moves right from 112
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:36] B&M passes buy trains
    ...
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:36] CPR passes buy trains
    # [21:36] CPR skips buy companies

    # [21:36] Player 3 operates NYNH
    g.process_action(action_helper.get_all_choices(g)[2])  # [21:37] NYNH lays tile #47 with rotation 0 on D16
    ...
    g.process_action(action_helper.get_all_choices(g)[8])  # [21:37] PRR lays tile #24 with rotation 1 on F14
    # [21:37] PRR skips place a token
    g.process_action(action_helper.get_all_choices(g)[0])  # [21:37] PRR runs a D train for $180: F2-H10-H12-H16-H18
    g.process_action(
        action_helper.get_all_choices(g)[0]
    )  # [21:37] PRR pays out 18 per share (54 to Player 1, $54 to PRR)
    # [21:37] PRR's share price moves right from 76
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:37] PRR passes buy trains
    ...
    g.process_action(action_helper.get_all_choices(g)[0])  # [21:38] ERIE runs a 5 train for $170: F2-E11-D10
    g.process_action(action_helper.get_all_choices(g)[0])  # [21:38] ERIE pays out 17 per share (85 to ERIE)
    # [21:38] ERIE's share price moves right from 71
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:38] ERIE passes buy trains
    # [21:38] ERIE skips buy companies

    # [21:38] Player 4 operates B&O
    g.process_action(action_helper.get_all_choices(g)[3])  # [21:38] B&O lays tile #9 with rotation 0 on E15
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:39] B&O passes place a token
    g.process_action(action_helper.get_all_choices(g)[0])  # [21:39] B&O runs a D train for $220: F2-H10-I15-J14-K13
    g.process_action(
        action_helper.get_all_choices(g)[0]
    )  # [21:39] B&O pays out 22 per share (88 to B&O, $22 to Player 1)
    # [21:39] B&O's share price moves right from 67
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:39] B&O passes buy trains
    # [21:39] B&O skips buy companies

    # [21:39] Player 1 operates NYC
    g.process_action(action_helper.get_all_choices(g)[5])  # [21:39] NYC lays tile #28 with rotation 0 on D12
    # [21:39] NYC skips place a token
    g.process_action(action_helper.get_all_choices(g)[0])  # [21:39] NYC runs a 6 train for $300: F2-F16-G17-G19-H18-I15
    g.process_action(
        action_helper.get_all_choices(g)[0]
    )  # [21:39] NYC pays out 30 per share (90 to NYC, $60 to Player 4)
    # [21:39] NYC's share price moves right from 60
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:39] NYC passes buy trains
    ...
    assert action_helper.get_state(g) == expected_state, "State does not match expected state after operating round 6"

    # Stock Round 7
    g.process_action(
        action_helper.get_all_choices(g)[5]
    )  # [21:46] Player 3 buys a 10% share of NYC from the market for $60
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:46] Player 3 declines to sell shares

    g.process_action(
        action_helper.get_all_choices(g)[6]
    )  # [21:46] Player 4 buys a 10% share of NYC from the market for $60
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:47] Player 4 declines to sell shares

    g.process_action(
        action_helper.get_all_choices(g)[5]
    )  # [21:47] Player 1 buys a 10% share of NYC from the market for $60
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:47] Player 1 declines to sell shares

    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:47] Player 2 passes

    g.process_action(
        action_helper.get_all_choices(g)[4]
    )  # [21:47] Player 3 buys a 10% share of B&O from the market for $67
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:47] Player 3 declines to sell shares
    ...
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:48] Player 2 passes

    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:48] Player 3 passes

    g.process_action(
        action_helper.get_all_choices(g)[2]
    )  # [21:48] Player 4 buys a 10% share of PRR from the market for $76
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:48] Player 4 declines to sell shares

    g.process_action(
        action_helper.get_all_choices(g)[4]
    )  # [21:48] Player 1 buys a 10% share of B&O from the market for $67
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:48] Player 1 declines to sell shares
    ...
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:48] Player 4 passes

    g.process_action(
        action_helper.get_all_choices(g)[3]
    )  # [21:49] Player 1 buys a 10% share of ERIE from the market for $71
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:49] Player 1 declines to sell shares
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:49] Player 2 passes
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:49] Player 3 passes
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:49] Player 4 passes
    g.process_action(action_helper.get_all_choices(g)[-1])  # [21:49] Player 1 passes
    action_helper.print_summary(g, json_format=True)
    expected_state = {
        "players": {
            "Player 1": {
    ...
    assert action_helper.get_state(g) == expected_state, "State does not match expected state after stock round 7"
    ...
    assert action_helper.get_state(g) == expected_state, "State does not match expected state at the end of the game"
...
def test_1830_manual_bankrupcy():
    ...
    g.process_action(action_helper.get_all_choices(g)[-1])  # [23:35] NYC passes lay/upgrade track
    # [23:35] NYC skips place a token
    # [23:35] NYC skips run routes
    # [23:35] NYC does not run
    # [23:35] NYC's share price moves left from 65
    g.process_action(action_helper.get_all_choices(g)[0])  # [23:35] NYC buys a 2 train for $80 from The Depot
    g.process_action(action_helper.get_all_choices(g)[0])  # [23:35] NYC buys a 2 train for $80 from The Depot
    g.process_action(action_helper.get_all_choices(g)[0])  # [23:35] NYC buys a 2 train for $80 from The Depot
    g.process_action(action_helper.get_all_choices(g)[0])  # [23:36] NYC buys a 2 train for $80 from The Depot
    # [23:36] NYC skips buy companies
    # [23:36] Player 3 operates C&O
    # [23:36] C&O places a token on F6
    g.process_action(action_helper.get_all_choices(g)[-1])  # [23:36] C&O passes lay/upgrade track
    # [23:36] C&O skips place a token
    # [23:36] C&O skips run routes
    # [23:36] C&O does not run
    # [23:36] C&O's share price moves left from 65
    g.process_action(action_helper.get_all_choices(g)[0])  # [23:36] C&O buys a 3 train for $180 from The Depot
    # [23:36] -- Phase 3 (Operating Rounds: 2 | Train Limit: 4 | Available Tiles: Yellow, Green) --
    g.process_action(action_helper.get_all_choices(g)[-2])  # [23:36] C&O buys a 3 train for $180 from The Depot
    g.process_action(action_helper.get_all_choices(g)[-2])  # [23:36] C&O buys a 3 train for $180 from The Depot
    g.process_action(action_helper.get_all_choices(g)[-1])  # [23:36] C&O passes buy trains
    # [23:36] C&O passes buy companies
    # [23:36] Player 4 operates PRR
    g.process_action(action_helper.get_all_choices(g)[-1])  # [23:36] PRR passes lay/upgrade track
    g.process_action(action_helper.get_all_choices(g)[-1])  # [23:36] PRR passes place a token
    g.process_action(action_helper.get_all_choices(g)[-1])  # [23:36] PRR runs a 2 train for $30: H12-H10
    g.process_action(
        action_helper.get_all_choices(g)[-1]
    )  # [23:36] PRR pays out 3 per share (12 to Player 4, $3 to Player 3)
    # [23:36] PRR's share price moves right from 50
    g.process_action(action_helper.get_all_choices(g)[-2])  # [23:36] PRR buys a 3 train for $180 from The Depot
    g.process_action(action_helper.get_all_choices(g)[-2])  # [23:36] PRR buys a 3 train for $180 from The Depot
    g.process_action(action_helper.get_all_choices(g)[-2])  # [23:36] PRR buys a 4 train for $300 from The Depot
    ...
    g.process_action(action_helper.get_all_choices(g)[-1])  # [23:36] PRR passes buy companies
    # [23:36] Player 1 operates B&O
    g.process_action(action_helper.get_all_choices(g)[-1])  # [23:36] B&O passes lay/upgrade track
