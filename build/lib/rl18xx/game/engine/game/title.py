...
__all__ = ['Entities', 'G1830Map', 'G1830Meta', 'G1830Game']
...
from game.engine.game.base import Meta as BaseMeta

class G1830Meta(BaseMeta):
...
class G1830Game(BaseGame):
    def __init__(self):
        super().__init__(G1830Meta, Entities, Map)
