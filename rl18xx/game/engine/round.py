...
# %% auto 0
__all__ = ['steps', 'BaseStep', 'Auctioner', 'Programmer', 'ShareBuying', 'EmergencyMoney', 'Train', 'BuyTrain',
           'PassableAuction', 'Tokener', 'TokenMerger', 'AcquireCompany', 'Assign', 'AutomaticLoan', 'Bankrupt',
           'BuyCompany', 'BuySellParShares', 'BuySellParSharesCompanies', 'BuySellParSharesViaBid',
           'BuySingleTrainOfType', 'CompanyPendingPar', 'ConcessionAuction', 'CorporateBuyShares',
           'CorporateSellShares', 'DiscardTrain', 'Dividend', 'EndGame', 'Exchange', 'HalfPay', 'HomeToken',
           'IssueShares', 'Message', 'MinorHalfPay', 'MinorWithhold', 'Program', 'ProgrammerAuctionBid',
           'ProgrammerMergerPass', 'ReduceTokens', 'ReturnToken', 'Route', 'SelectionAuction', 'SimpleDraft',
           'SingleDepotTrainBuy', 'SpecialBuyTrain', 'SpecialBuy', 'SpecialChoose', 'SpecialToken', 'Tracker',
           'SpecialTrack', 'Token', 'Track', 'TrackAndToken', 'TrackLayWhenCompanySold', 'WaterfallAuction',
...
class BuySellParShares(BaseStep, ShareBuying, Programmer):
    ...
    def bought(self):
        return any(
            self.PURCHASE_ACTIONS.contains(x) for x in self.round.current_actions
        )
...
class Tracker:
    ...
    def pay_tile_cost(
        ...
        log_message = (
            f"{spender_name}"
            f"{' (' + entities_names + ')' if spender != entity and entity.is_company() else ''}"
...
class BaseRound:
    DEFAULT_STEPS = [EndGame, Message, Program]
...
# %% ../../../nbs/game/engine/06_round.ipynb 129
