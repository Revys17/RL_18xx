...
__all__ = ['AbilityBase', 'AcquireCompany', 'AdditionalToken', 'AssignCorporation', 'AssignHexes', 'BlocksHexes',
           ...
           'TrainBuy', 'TrainDiscount', 'TrainLimit', 'Abilities']
...
class AbilityBase(Ownable):
    def __init__(
        ...
        **opts
        ...
        self.when = [when for when in opts.pop("when", [])]
...
from .core import type_to_class_name
...
class Abilities:
    def __init__(self, abilities=[]):
        ...
        for ability in abilities:
            klass = type_to_class_name(ability["type"])
            ability_instance = globals()[klass](**ability)
